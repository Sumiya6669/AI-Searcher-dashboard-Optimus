/**
 * Форматирование. Часовой пояс один на всё приложение — время Казахстана.
 * Разные пояса в разных местах интерфейса означают, что «в 08:30» перестаёт
 * быть одним временем, а срок приёма заявок по лоту — вещь, в которой час
 * расхождения стоит участия в закупке.
 *
 * Пояс не выносится в настройку пользователя сознательно: сотрудник в
 * командировке должен видеть время офиса, иначе «осталось 19 часов» у двух
 * человек означает разные моменты.
 */
